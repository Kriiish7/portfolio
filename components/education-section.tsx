...
const education = [
    ...
    {
        period: "2020 — 2025",
        institution: "Maiden Erlegh School",
        description:
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-12">
                    {education.map((edu, index) => (
                        ...
                        >
                            {edu.current && (
                                <span className="absolute -left-[9px] top-0 w-4 h-4 bg-primary rounded-full animate-pulse" />
                            )}
                            {!edu.current && <span className="absolute -left-[5px] top-1 w-2 h-2 bg-muted-foreground rounded-full" />}
